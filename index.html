            ...
            <div class="carousel-caption" style="
              ...
              <div class="">
                <img
                  ...
                  class="circle wow bounceInRight animated"
              ...
              <h3 data-wow-duration="1000ms" class="wow slideInLeft animated">
                <span class="color">Your </span> One Stop Solution
              </h3>
              <p data-wow-duration="1000ms" class="wow slideInRight animated">
                We work for paperless institute
              </p>
              ...
              <ul class="social-links text-center">
                ...
                <li>
                  <a href="https://www.facebook.com/eimboxbangladesh"
              ...
              <div class="col-12 text-center d-flex " style="padding:15px;">
                <button class="btn btn-success " style="border-radius:20px; margin-right:10px;">
                  Register with us
                </button>
                
                <button class="btn btn-warning"  style="border-radius:20px;">Download Apps</button>
              </div>
          ...
          <div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
            <div class="service-item">
              ...
              <div class="service-desc">
                ...
                <p>
                  Manage real time attendance for your staffs and students with
                  SMS / Notification
                </p>
              </div>
            </div>
          ...
          >
            <div class="service-item">
              ...
              <div class="service-desc">
                ...
                <p>
                  Use out system to process your academic result. It may govt.
                  declared curriculum or your individual result system. We're
                  ready for both system.
                </p>
                <p>
                  Prepare tabulating sheet or progress report automatically.
                  Teachers may input their own subject's marks and monitor by
                  class teacher on real time.
                </p>
                <p><br /><br /><br /></p>
              </div>
            </div>
          ...
          >
            <div class="service-item">
              ...
              <div class="service-desc">
                ...
                <p>
                  Collect your student's payments and manage their dues report
                  in time automaitcally.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
            <div class="service-item">
              ...
              <div class="service-desc">
                <h3>Misc</h3>
                <p>Prepare Seat Card, Admit Card...............</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
          ...
          <div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
            <div class="service-item">
              ...
              <div class="service-desc">
                <h3>Cash Book</h3>
                <p>
                  Manage your columnar cash book and banking transaction. Track
                  your income/expenditures. Manage teachers Payroll system.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <p class="copyright text-center">
              Copyright © 2024 <a href="http://eimbox.com/">EIMBox</a>. All
              rights reserved. Designed & developed by
              <a href="http://eimbox.com/">EIMBox Developement Team</a>
            </p>
          </div>
        </div>
      </div>
